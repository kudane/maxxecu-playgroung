...
สิ่งแรกที่ต้องจำให้ขึ้นใจคือ **Air Flow = การปรับหยาบ (Coarse)** และ **Spark Timing = การปรับละเอียด (Fine)** วิทยากรย้ำเรื่องนี้หลายรอบมากเพราะคนมักสับสนว่าควรปรับอะไรก่อน
